...
#define V4L2_CID_CAMERA_CHECK_SENSOR_STATUS		(V4L2_CID_PRIVATE_BASE+125)

#if defined(CONFIG_MACH_Q1_REV02)
#define V4L2_CID_CAMERA_AE_LOCK_UNLOCK		(V4L2_CID_PRIVATE_BASE + 126)
...
#define V4L2_CID_CAMERA_AWB_LOCK_UNLOCK		(V4L2_CID_PRIVATE_BASE + 127)
...
#define V4L2_CID_CAMERA_FLASH_TEMP_MODE		(V4L2_CID_PRIVATE_BASE+ 128)
