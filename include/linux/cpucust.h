...
#define CUST_APLL_PMS_L0            ( ((200<<16)|(3<<8)|(0x1)) )
...
#define CUST_APLL_PMS_L1            ( ((188<<16)|(3<<8)|(0x1)) )

#define CUST_ARM_CLK_L2             1200000
#define CUST_ARM_V_L2               1275000
#define CUST_CLKDIV_CPU0_L2         { 0, 3, 7, 3, 4, 1, 7 }
#define CUST_CLKDIV_CPU1_L2         { 5, 0 }
#define CUST_APLL_PMS_L2            ( ((150<<16)|(3<<8)|(0x1)) )

#define CUST_ARM_CLK_L3             1000000
#define CUST_ARM_V_L3               1175000
#define CUST_CLKDIV_CPU0_L3         { 0, 3, 7, 3, 4, 1, 7 }
#define CUST_CLKDIV_CPU1_L3         { 4, 0 }
#define CUST_APLL_PMS_L3            ( ((250<<16)|(6<<8)|(0x1)) )

#define CUST_ARM_CLK_L4              800000
#define CUST_ARM_V_L4               1075000
#define CUST_CLKDIV_CPU0_L4         { 0, 3, 7, 3, 3, 1, 7 }
#define CUST_CLKDIV_CPU1_L4         { 3, 0 }
#define CUST_APLL_PMS_L4            ( ((200<<16)|(6<<8)|(0x1)) )

#define CUST_ARM_CLK_L5              500000
#define CUST_ARM_V_L5                975000
#define CUST_CLKDIV_CPU0_L5         { 0, 3, 7, 3, 3, 1, 7 }
#define CUST_CLKDIV_CPU1_L5         { 3, 0 }
#define CUST_APLL_PMS_L5            ( ((250<<16)|(6<<8)|(0x2)) )

#define CUST_ARM_CLK_L6              200000
#define CUST_ARM_V_L6                950000
#define CUST_CLKDIV_CPU0_L6         { 0, 3, 7, 1, 3, 1, 7 }
#define CUST_CLKDIV_CPU1_L6         { 3, 0 }
#define CUST_APLL_PMS_L6            ( ((200<<16)|(6<<8)|(0x3)) )


#define ARMCLOCK_HIGH               CUST_ARM_CLK_L2
#define ARMCLOCK_MID                CUST_ARM_CLK_L3
#define ARMCLOCK_LOW                CUST_ARM_CLK_L5
#define CUST_SUSPEND_LV             L4
#define CUST_REBOOT_LV              L2
