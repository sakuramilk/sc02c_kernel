...
{0x27, 0x3c},
{0x2b, 0x80},
{0x2e, 0x00}, //20110926_Don't touch modify(0x11->0x00)
{0x2f, 0x00}, //20110926_Don't touch modify(0xa1->0x00)
...
//==========================================================
regs_short_t  front_init_vt_15_regs[] = {
/////// Start Sleep ///////
{0x01, 0xf9}, //sleep on
{0x08, 0x0f}, //Hi-Z on
{0x01, 0xf8}, //sleep off
...
regs_short_t front_ev_vt_minus_4_regs[] = {
{0x03, 0x10},
{0x40, 0xd0},
};

regs_short_t front_ev_vt_minus_3_regs[] = {
{0x03, 0x10},
{0x40, 0xc0},
};

regs_short_t front_ev_vt_minus_2_regs[] = {
{0x03, 0x10},
{0x40, 0xb0},
};

regs_short_t front_ev_vt_minus_1_regs[] = {
{0x03, 0x10},
{0x40, 0xa0},
};

regs_short_t front_ev_vt_default_regs[] = {
{0x03, 0x10},
{0x40, 0x00},
};

regs_short_t front_ev_vt_plus_1_regs[] = {
{0x03, 0x10},
{0x40, 0x20},
};

regs_short_t front_ev_vt_plus_2_regs[] = {
{0x03, 0x10},
{0x40, 0x30},
};

regs_short_t front_ev_vt_plus_3_regs[] = {
{0x03, 0x10},
{0x40, 0x40},
};

regs_short_t front_ev_vt_plus_4_regs[] = {
{0x03, 0x10},
{0x40, 0x50},
};
