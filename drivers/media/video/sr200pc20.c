...
#define INIT_VT_15_NUM_OF_REGS             (sizeof(front_init_vt_15_regs) / sizeof(regs_short_t))
...
int sr200pc20_regs_table_init(void)
{
	...
	filp = filp_open("/mnt/sdcard/sr200pc20_regs-p2_50Hz.h", O_RDONLY, 0);
#elif defined (CONFIG_VIDEO_ANTIBANDING_60Hz)
	filp = filp_open("/mnt/sdcard/sr200pc20_regs-p2_60Hz.h", O_RDONLY, 0);
#else
...
static int sr200pc20_set_frame_rate(struct v4l2_subdev *sd, u32 fps)
{
	...
	switch (fps) {
	case 7:
		cam_dbg("load sr200pc20_vt_7fps\n");
		err = sr200pc20_i2c_set_config_register(client,
										  front_fps_7_regs,
										  FPS_7_NUM_OF_REGS,
										  "front_fps_7_regs");
		break;
	case 10:
		cam_dbg("load sr200pc20_vt_10fps\n");
		err = sr200pc20_i2c_set_config_register(client,
										  front_fps_10_regs,
										  FPS_10_NUM_OF_REGS,
										  "front_fps_10_regs");
		break;
	case 15:
		cam_dbg("load sr200pc20_vt_15fps\n");
		err = sr200pc20_i2c_set_config_register(client,
										  front_fps_15_regs,
										  FPS_15_NUM_OF_REGS,
										  "front_fps_15_regs");
