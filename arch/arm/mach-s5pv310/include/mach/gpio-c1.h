...
#elif defined(CONFIG_MACH_C1_NA_SPR_REV05) || defined(CONFIG_MACH_C1_NA_SPR_EPIC2_REV00) || defined(CONFIG_MACH_C1_NA_USCC_REV05)
#include "gpio-c1-na-spr-rev05.h"
#elif defined(CONFIG_MACH_C1_KDDI_REV00)
#include "gpio-c1-kddi-rev00.h"
#else
