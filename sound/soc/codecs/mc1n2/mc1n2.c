...
#if defined(CONFIG_FREQ_OVERCLOCK)
#define MC1N2_LOCK_CPU_L CPU_L5
#else
#define MC1N2_LOCK_CPU_L CPU_L4
#endif
				      ...
				      struct mc1n2_ctrl_args *args)
{
	...
	case MCDRV_NOTIFY_MEDIA_PLAY_START:
		if (mc1n2_freq_lock)
			s5pv310_cpufreq_lock(DVFS_LOCK_ID_SND, MC1N2_LOCK_CPU_L); // CPU CLK lower lock 100MHz
		break;
